...
knitr::opts_chunk$set(fig.width=3, fig.height=1, echo=FALSE, warning=FALSE, message=FALSE, dpi = 300)
...
When the Hazelwood power station shut last year the Australian Conservation Foundation claimed that its closure was a signal that "the era of polluting coal is coming to an end."
...
![](C:\Users\matt\Dropbox\01a. Resources\data\BP\images\p_delta_ap.png)
