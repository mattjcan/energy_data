...
p_g_demand <- demand_by_globe %>% 
  ...
  theme_mc + 
  labs(title = "Global coal consumption", subtitle = "million tonnes of oil equivalent", caption = "Source: BP Statistical Review of World Energy", x ="", y = "") +
  ylim(200,4000)
...
f_r_demand <- function(reg) {
  ...
  theme_mc + 
  labs(title = paste("Coal consumption in", reg), subtitle = "million tonnes of oil equivalent", caption = "Source: BP Statistical Review of World Energy", x ="", y = "") 
}
...
f_c_demand <- function(country) { 
  ...
  geom_line(color = "#2166ac", size = 1) + 
  theme_mc + 
  labs(title = paste("Coal consumption in", country), subtitle = "million tonnes of oil equivalent", caption = "Source: BP Statistical Review of World Energy", x ="", y = "") 
}
...
p_g_supply <- supply_by_globe %>% 
  ...
  geom_line(color = "#4484ce", size = 1) + 
  theme_mc + 
  labs(title = "Global coal production", subtitle = "million tonnes", caption = "Source: BP Statistical Review of World Energy", x ="", y = "") 
...
f_r_supply <- function(reg) {
  supply_by_region %>% 
    ...
    geom_line(color = "#2166ac", size = 1) + 
    theme_mc + 
    labs(title = paste("Coal production in", reg), subtitle = "million tonnes of oil equivalent", caption = "Source: BP Statistical Review of World Energy", x ="", y = "") 
}
...
f_c_supply <- function(country) { 
  coal_supply %>% 
    ...
    geom_line(color = "#2166ac", size = 1) + 
    theme_mc + 
    labs(title = paste("Coal production in", country), subtitle = "million tonnes of oil equivalent", caption = "Source: BP Statistical Review of World Energy", x ="", y = "") 
}
...
p_delta <- fuel_delta %>% 
  ...
  labs(title = paste("Change in global electricity generation from 2016 to 2017"), subtitle = "terawatt hours", caption = "Source: BP Statistical Review of World Energy", x = "", y = "") +
...
p_delta_ap <- fuel_delta_ap %>% 
  ...
  scale_fill_manual(values = c(coal = "black", gas = "#762a83", hydro = "#F19F4D", nuclear = "#d73027", oil = "#4d4d4d", solar = "#4d9221", wind = "#4484ce")) +
  scale_x_discrete(labels = c("Coal", "Solar", "Wind", "Nuclear", "Gas", "Hydro", "Oil")) +
  labs(title = paste("Change in electricity generation in Asia Pacific from 2016 to 2017"), subtitle = "terawatt hours", caption = "Source: BP Statistical Review of World Energy", x = "", y = "") +
  theme(panel.grid.major = element_blank()) +
  geom_text(aes(label = paste(round(delta,1)), vjust = ifelse(delta >= 0, -1, 1.5)), size=3) +
  ylim(-75, 400)
